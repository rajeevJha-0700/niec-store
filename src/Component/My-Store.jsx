  ...
  return (
    <div className="container mx-auto px-4 py-16 min-h-[calc(100vh-12rem)]">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link
          to="/add-product"
          className="bg-red-500 text-white px-4 py-2 rounded-md font-semibold hover:bg-indigo-700 hover:scale-105 transition-all duration-300 flex items-center gap-2"
        >
          <svg
            className="w-5 h-5"
            fill="none"
